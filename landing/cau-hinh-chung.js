...
$(document).ready(function() {
	$('.enter-submit').click(function(){
		...
		var urlApi = 'http://log.lazishop.com:8902/orders';
...
$('#form1').on('hidden.bs.modal', function () {
    $('.page-element').removeClass('bigpop');
});
$('#form2').on('hidden.bs.modal', function () {
    $('.page-element').removeClass('bigpop');
});
$('#form3').on('hidden.bs.modal', function () {
    $('.page-element').removeClass('bigpop');
});
$('#form4').on('hidden.bs.modal', function () {
    $('.page-element').removeClass('bigpop');
});
$('#form5').on('hidden.bs.modal', function () {
    $('.page-element').removeClass('bigpop');
});
});
