...
if(data.show_type == 1){
	...
	if( numItems === f ){
		formhtml += '<script src="http://lazishop.net/landing/ladipage/formtest/thuoctinh_cau-hinh-form.js"><\/script>';
	}
	...
	if( numItems === f ){
		formhtml += '<script src="http://lazishop.net/landing/ladipage/formtest/thuong_cau-hinh-form.js"><\/script>';
	}
...
if( numItempop == k ){
	popuphtml += '<script src="http://lazishop.net/landing/ladipage/formtest/thuoctinh_cau-hinh-pop.js"><\/script>';
